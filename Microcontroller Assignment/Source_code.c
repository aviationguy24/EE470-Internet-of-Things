//===============================
// Title: Photoresistor Lux Meter + RGB/Buzzer Indicator
//===============================
// Program Detail:
//-------------------------------
// Purpose: Read ambient light with an HW-486 (LDR) on NodeMCU-ESP12,
//          convert ADC → Lux using a 2-point power-law calibration,
//          and indicate level by RGB color (blue→red) and a buzzer in dark.
...
// Versions:
//   V1 – Initial bring-up: basic ADC read + RGB/Buzzer I/O scaffold
//
// File Dependencies:
//   N/A
//
...
//
// Usage Notes:
//   - Set L1_LUX / L2_LUX to your two reference lux points before calibration.
//===============================
...
// LED color transition range (blue->red). Choose what you want the visual to cover.
const float LUX_MAX_DISPLAY   = 1000.0f;  // red at ~1000 lux


// Auto buzzer threshold (uses printed/clamped lux)
...
// NOTE: Now clamps lux to 0..3000 so you don't see crazy-high numbers.
...
void loop(){
  ...
  // End manual window after ~5s without blocking
